                ...
                <div class="w-75" style="margin:auto;">
                    ...
                    <?php
                        ...
                        echo '<div class="form-group row">
                            ...
                            <div class="col-sm-8 pt-1">'.$name.'</div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Chức vụ</label>
                            <div class="col-sm-8 pt-1">'.$position.'</div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Địa chỉ</label>
                            <div class="col-sm-8 pt-1">'.$address.'</div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-2 col-form-label">Số điện thoại</label>
                            <div class="col-sm-8 pt-1">'.$phone.'</div>
                        </div>';
                    ?>
                    <div style="margin-left:75px;"><a href="InforForm.php"><button class="btn btn-primary">Cập nhật</button></a></div>
                </div> 
            </div>
        </div>
    </div>
