    ...
    <div id="particles-js">
        ...
        <div class="dashboard">
            ...
            <div class="container w-100" style="height: max-content;">
                <div class="bg-dark text-white" style="text-align:center;"><h3>Thêm loại hàng hóa</h3></div>
                <div class="w-50" style="margin:auto;">
                    <form action="CreateCategory.php" method="post">
                        <div class="form-group row">
                            <label for="name" class="col-sm-3 col-form-label">Tên loại hàng</label>
                            <div class="col-sm-7">
                                <input type="text" class="form-control" name="name" placeholder="Tên loại hàng" required>
                            </div>
                        </div>
                        <div style="margin-left:150px;"><button type="submit" class="btn btn-primary">Thêm</button></div>
                    </form>
                </div>
            </div>
        </div>
