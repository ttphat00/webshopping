    ...
    <div id="particles-js">
        ...
        <div class="dashboard">
            ...
            <div class="container w-100" style="height: max-content;">
                <div class="bg-dark text-white myshop"><h3>Danh sách đơn đặt hàng</h3></div>
                                ...
                                while($row = mysqli_fetch_assoc($result)) {
                                    if($row['NgayGH'] === null){
                                        ...
                                        echo '<tr>
                                            ...
                                            <td>'.$row['NgayDH'].'</td>
                                            <td>
                                                <a href="ConfirmForm.php?id='.$row['MSKH'].'"><button class="btn btn-primary mr-2">Xem</button></a>
                                                <a href="DeleteOrder.php?idkh='.$row['MSKH'].'&idddh='.$row['SoDonDH'].'"><button class="btn btn-danger">Hủy</button></a>
                                            </td>
                                        </tr>';
                                    }
                                }
